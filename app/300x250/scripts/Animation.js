...
function start() {
	...
	.to(txt1, 1, {x:'-=300', ease: Expo.easeOut}, "-=1")

	.to(txt1Blur, 1, {x:'-=300', ease: Expo.easeOut}, "-=1")
	.to(txt1Blur, .75, {opacity:0, ease: Expo.easeOut}, "-=.75")

	.to(txt1, 1, {x:'-=300', ease: Expo.easeIn}, "+=2")

	.to(txt1Blur, 1, {x:'-=300', ease: Expo.easeIn}, "-=1")
	...
	.to(txt2Blur, 1, {x:'-=300', ease: Expo.easeOut}, "-=1")
	.to(txt2Blur, .75, {opacity:0, ease: Expo.easeOut}, "-=.75")

	.to(cta, .5, {opacity:1}, "-=.25")
	.from(cta_txt, 1, {x:"-=300", ease:Expo.easeOut}, "-=.25")
